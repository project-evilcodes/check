...
class Dashboard extends Component {
    ...
    componentDidMount = () => {
        ...
        axios.get(baseURL + `/api/admin/redhat`, {
            headers: {
    ...
    delPast = (e) => {
        ...
        if (window.confirm('Are you sure you want to remove this item?')) {
            console.log("del");
            /// delete payment
            axios.post(baseURL + `/api/admin/redhat/delete`, {id: id}, {
                headers: {
                    'Content-Type': 'application/json',
                    'Access-Control-Allow-Headers': 'x-access-token',
                    'x-access-token': localStorage.getItem("jwtToken")
        ...
        if (user.role === 3) {
            ...
            this.state.payments.map(payment =>
                data.push({
                    ...
                    body: payment.body,
                    actions: <div>
                        <a href={'/admin/redhat/edit/' + payment._id} className={"btn pay-btn btn-full-blue"}>Edit</a>
