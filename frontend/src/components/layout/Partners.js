...
class Landing extends Component {
    ...
    componentDidMount = () => {
        ...
        axios.get(baseURL + `/api/u/redhat`, {}).then((res) => {
                            ...
                            <div className="row align-items-end margin-6-rem-bottom">
                                ...
                                <div className="col-12 col-xl-6 col-lg-4 text-center text-lg-end wow animate__fadeIn">
                                    <a href="https://cyberacademy.lk/classes"
                                       className="btn btn-link thin btn-extra-large text-dark-purple font-weight-600"
                                    ...
                                    this.state.courses.map(course =>
                                        <div
                                            ...
                                            <div
                                                ...
                                                <span
                                                    className="alt-font font-weight-500 text-extra-medium text-extra-dark-gray d-block margin-10px-bottom">{course.title}</span>
                                                ...
                                                <a className="alt-font font-weight-600 text-small text-dark-purple text-salmon-rose-hover text-uppercase d-flex align-items-center"
                                                   href={"https://cyberacademy.lk/classes"} target={"_blank"} rel="noopener noreferrer">Explore<i
