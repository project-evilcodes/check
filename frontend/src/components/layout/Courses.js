    ...
    render() {
        return (
            <div style={{backgroundColor: "#ffffff"}}>
                ...
                {/* start section */}
                <section
                    className="big-section bg-very-light-desert-storm overlap-height overflow-visible md-no-overlap-section" style={{paddingBottom: "80px"}}>
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    {course.fee === 0 ? "FREE" : "LKR " + course.fee}
                                                </div>
                                                <span
